...
class CameraErrorWindowUI(QWidget):
    def __init__(self, error_cams_text):
        ...
        self.label_title = QLabel("重大なエラー", self)
...
class MainWindowUI(QMainWindow):
    def __init__(self):
        ...
        self.cam_in = QLabel("カメラ_内側", self)
        ...
        self.cam_out = QLabel("カメラ_外側", self)
        ...
        self.cam_under = QLabel("カメラ_下側", self)
        ...
        self.cam_top = QLabel("カメラ_上側", self)
